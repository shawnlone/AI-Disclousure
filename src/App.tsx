...
const copy = {
  en: {
    ...
    title: 'Create clear AI-use disclosures for publishing platforms.',
    subtitle:
    ...
    resultSubtitle:
      'Generate a platform-aware draft, refine it in place, and copy the version you are ready to publish or submit.',
    primary: 'Disclosure statement',
    short: 'Brief public notice',
  ...
  zh: {
    ...
    reset: '重置',
    resultTitle: '可编辑草稿',
    resultSubtitle: '生成贴近平台场景的草稿，直接修改后复制用于发布、提交或客户交付。',
    primary: '披露声明',
    short: '简短公开说明',
    structured: '提交摘要',
    clarity: '披露提示',
